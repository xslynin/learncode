...
#define EXCEPT_VECTOR_TABLE     0xD0037400
// #define EXCEPT_RESET            (EXCEPT_VECTOR_TABLE + 0x00)
// #define EXCEPT_UNDEF            (EXCEPT_VECTOR_TABLE + 0x04)
// #define EXCEPT_SOFT_INTERRU     (EXCEPT_VECTOR_TABLE + 0x08)
// #define EXCEPT_PREFETCH         (EXCEPT_VECTOR_TABLE + 0x0C)
// #define EXCEPT_DATA             (EXCEPT_VECTOR_TABLE + 0x10)
// #define EXCEPT_IRQ              (EXCEPT_VECTOR_TABLE + 0x18)
// #define EXCEPT_FIQ              (EXCEPT_VECTOR_TABLE + 0x1C)

#define r_execpt_reset          reg_depoint(EXCEPT_VECTOR_TABLE,0x00)
#define r_execpt_undef          reg_depoint(EXCEPT_VECTOR_TABLE,0x04)
#define r_execpt_soft_int       reg_depoint(EXCEPT_VECTOR_TABLE,0x08)
#define r_execpt_prefetch       reg_depoint(EXCEPT_VECTOR_TABLE,0x0C)
#define r_execpt_data           reg_depoint(EXCEPT_VECTOR_TABLE,0x10)
#define r_execpt_irq            reg_depoint(EXCEPT_VECTOR_TABLE,0x18)
#define r_execpt_fiq            reg_depoint(EXCEPT_VECTOR_TABLE,0x1C)
